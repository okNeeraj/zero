<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="exampleTopNavbar">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="#">Page Heading</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="ti ti-file"></i> Documentation</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><i class="ti ti-stats-up"></i> Reports</a>
            </li>
            <li class="nav-item">
